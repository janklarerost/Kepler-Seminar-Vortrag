...
\begin{frame}{1. Keplersches Gesetz}
    ...
    \begin{center}
        ...
        \coordinate (Ref) at (3.5,0); % NEU: Unsichtbarer Hilfspunkt auf der Achse
...
\begin{frame}{2. Keplersches Gesetz (Flächensatz)}
    ...
    \begin{columns}
        ...
        Physikalisch bedeutet dies die \textbf{Drehimpulserhaltung}. Für uns relevant ist die Winkelgeschwindigkeit $\dot{\vartheta}$:
        ...
        \begin{itemize}
            \item $L$: Drehimpuls
            \item $m$: Planetenmasse
            \item $\dot{\vartheta}$: Winkelgeschwindigkeit
        \end{itemize}
        \textit{Fazit: $\dot{\vartheta}$ hängt direkt vom aktuellen Radius ab!}
        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.85]
                ...
                % Ellipse (Jetzt passend zu Folie 2)
                \draw[thick] (0,0) ellipse (2.5cm and 1.5cm);
                ...
                % Sonne (Sonne sitzt nun bei x=2 wie auf Folie 2)
    ...
    \note{
        ...
        Wir haben Ihnen hier die wesentliche Formel mitgebracht. Da der Drehimpuls konstant ist, sehen wir sofort unseren wichtigsten physikalischen Zusammenhang für heute: Die Winkelgeschwindigkeit hängt direkt vom aktuellen Radius ab.\\
        Die Grafik rechts zeigt das deutlich: Ist der Planet nah an der Sonne (bei $A_1$), ist $r$ klein, also muss die Geschwindigkeit groß sein, damit die gleiche Fläche überstrichen wird wie hinten bei $A_2$.
    }
\end{frame}
