...
\begin{frame}{Gilt das auch für elliptische Bahnen?}
    ...
    \textbf{Beispiel Komet 67P:} (Starke Exzentrizität, $e \approx 0.641$)
    \begin{itemize}
        \item Erde: $a \approx 149,6 \cdot 10^6 \text{ km}$, $T = 1 \text{ Jahr}$
        \item 67P: $a \approx 518 \cdot 10^6 \text{ km}$, $T = 6.44 \text{ Jahre}$
    \end{itemize}

    \begin{align*}
        \dfrac{T_{\text{Erde}}^2}{a_{\text{Erde}}^3} & \approx 0.297 \cdot 10^{-18} \, \dfrac{\text{s}^2}{\text{m}^3} \\[1em]
        \dfrac{T_{\text{67P}}^2}{a_{\text{67P}}^3} & \approx 0.297 \cdot 10^{-18} \, \dfrac{\text{s}^2}{\text{m}^3}
    \end{align*}
    ...
    \note{
        ...
        Schauen wir uns den Komet 67P an, der eine sehr exzentrische Bahn hat. Vergleichen wir die Erde und den Komet 67P und setzen ihre echten Daten in den Bruch ein, kommen wir bei beiden exakt auf den gleichen Wert.\\
        ...
        Komet 67P: Erster Komet der von Raumsonde begleitet wurde (Rosetta)
    }
\end{frame}
...
\begin{frame}{Berechnung der Umlaufzeit}
    ...
    \vspace{0.2cm}
    \textbf{Problem:} Dieses Integral lässt sich nicht einfach in geschlossener Form auswerten.
...
\begin{frame}{Auswertung der Ableitung}
    ...
    \begin{align*}
        \int_0^{2\pi} \frac{1}{(1 + e \cos(\vartheta))^2} \, d\vartheta & = \frac{4}{i e^2} \cdot 2\pi i \cdot \frac{e^2}{4(1-e^2)^{\frac{3}{2}}} = \boxed{\frac{2\pi}{(1-e^2)^{\frac{3}{2}}}}
    \end{align*}
